...
Aplicación Ionic/Angular para registrar cuidados de mascotas, conservar registros pendientes en el navegador y demostrar su sincronización. Incluye vistas de demostración para collar, sensores, NFC y alertas.
